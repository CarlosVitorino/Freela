                    ...
                    >
                      ...
                      <Form.Item wrapperCol={{ offset: 4, span: 16 }}>
                        <Space>
                          ...
                          <Button type="secondary" onClick={() => supplierForm.current.resetFields()}>
                            Reset
                          </Button>
                        </Space>
                      </Form.Item>
                        ...
                        <List.Item className="row-wrapper">
                          ...
                          <Space className="float-button">
                            <Popconfirm
                              ...
                              onConfirm={() => handleDeleteRecord(item, "supplier")}
                            >
                            ...
                            <Tooltip title="Edit">
                              <Button
                                ...
                                onClick={() => supplierForm.current.setFieldsValue(item)}
                                icon={<EditOutlined />}
                              />
                            </Tooltip>
                          </Space>
                ...
                <Row {...layout}>
                    ...
                    >
                      ...
                      <Form.Item wrapperCol={{ offset: 4, span: 16 }}>
                        <Space>
                          ...
                          <Button type="secondary" onClick={() => typeForm.current.resetFields()}>
                            Reset
                          </Button>
                        </Space>
                      </Form.Item>
                  ...
                  <Col className="list" xs={{ span: 24 }} lg={{ span: 12 }}>
                    ...
                    <List
                      ...
                      renderItem={(item) => (
                        <List.Item className="row-wrapper">
                          <List.Item.Meta title={<Text strong>{item.label}</Text>} description={item.description} />
                          <Space className="float-button">
                            <Popconfirm
                              title="Are you sure, you want to DELETE this record?"
                              onConfirm={() => handleDeleteRecord(item, "type")}
                            >
                              <Tooltip title="Delete">
                                <DeleteFilled className="action-icon" />
                              </Tooltip>
                            ...
                            <Tooltip title="Edit">
                              <Button
                                type="link"
                                className="action-icon"
                                onClick={() => typeForm.current.setFieldsValue(item)}
                                icon={<EditOutlined />}
                              />
                            </Tooltip>
                          </Space>
                  ...
                  <Col xs={{ span: 24 }} lg={{ span: 12 }}>
                    ...
                    >
                      ...
                      <Form.Item
                        label="Session Type"
                        name="type_value"
                        rules={[{ required: true, message: "Please select the type associated!" }]}
                      >
                        <Select placeholder="Select a option" allowClear options={typesData} />
                      </Form.Item>
                      <Form.Item label="Description" name="description">
                        <Input.TextArea rows={4} />
                      </Form.Item>
                      <Form.Item wrapperCol={{ offset: 4, span: 16 }}>
                        <Space>
                          ...
                          <Button type="secondary" onClick={() => subTypeForm.current.resetFields()}>
                            Reset
                          </Button>
                        </Space>
                      </Form.Item>
                        ...
                        return (
                          <List.Item className="row-wrapper">
                            <List.Item.Meta
                              title={
                                <>
                                  ...
                                  <Text> {typeName && ` (${typeName.label})`}</Text>
                                </>
                              }
                            ...
                            <Space className="float-button">
                              <Popconfirm
                                title="Are you sure, you want to DELETE this record?"
                                onConfirm={() => handleDeleteRecord(item, "subType")}
                              >
                                <Tooltip title="Delete">
                                  <DeleteFilled className="action-icon" />
                                </Tooltip>
                              ...
                              <Tooltip title="Edit">
                                <Button
                                  type="link"
                                  className="action-icon"
                                  onClick={() => subTypeForm.current.setFieldsValue(item)}
                                  icon={<EditOutlined />}
                                />
                              </Tooltip>
                            </Space>
