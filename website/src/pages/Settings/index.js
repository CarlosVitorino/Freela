                    ...
                    >
                      ...
                      <Form.Item wrapperCol={{ offset: 4, span: 16 }}>
                        <Space>
                          ...
                          <Button
                            type="secondary"
                            onClick={() => supplierForm.current.resetFields()}
                          >
                            Reset
                          </Button>
                        </Space>
                    ...
                    >
                      ...
                      <Form.Item
                        ...
                        rules={[
                          {
                            required: true,
                            message: 'Please input subtype name!',
                          },
                        ]}
                      >
                        <Input />
                      ...
                      <Form.Item
                        ...
                        rules={[
                          {
                            required: true,
                            message: 'Please select the type associated!',
                          },
                        ]}
                      >
                      ...
                      <Form.Item wrapperCol={{ offset: 4, span: 16 }}>
                        <Space>
                          ...
                          <Button
                            type="secondary"
                            onClick={() => subTypeForm.current.resetFields()}
                          >
                            Reset
                          </Button>
                        </Space>
