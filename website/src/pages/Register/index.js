    ...
    _service({
      ...
      fail: () => {
        ...
        notification.error({
          ...
          description:
            'Unable to create the account, please contact us to try again after doing the back flip.',
        });
      },
    });
  }
          ...
          >
            <Form.Item
              ...
              rules={[
                ...
                {
                  type: 'string',
                  message: 'Invalid name, only lower case and upper case letters supported.',
                  pattern:
